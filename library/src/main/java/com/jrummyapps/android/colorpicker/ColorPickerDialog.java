...
public class ColorPickerDialog extends DialogFragment implements OnTouchListener, OnColorChangedListener, TextWatcher {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View content = rootView.findViewById(R.id.contentMessage);
        if (content != null) {
            conntentMessageView = (TextView) content;
            if (contentMessage != 0) {
                conntentMessageView.setVisibility(View.VISIBLE);
                conntentMessageView.setText(contentMessage);
            } else {
                conntentMessageView.setVisibility(View.GONE);
            }
        }
        ...
        if (showSelectButton) {
            builder.setPositiveButton(R.string.cpv_select, new DialogInterface.OnClickListener() {
                @Override
    ...
    public static final class Builder {
        ...
        public Builder setNegativeTitle(int negativeTitle) {
        ...
        public Builder setContentMessage(int contentMessage) {
            this.contentMessage = contentMessage;
            return this;
        }

        public Builder setShowSelectButton(boolean showSelectButton) {
